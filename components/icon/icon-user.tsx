...
const IconUser: FC<IconUserProps> = ({ className, fill = false }) => {
    return (
        <>
            {!fill ? (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" className={className}>
                ...
                <svg width="18" height="18" viewBox="0 0 18 18" fill="white" className={className}>
