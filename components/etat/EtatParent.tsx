...
const EtatParent = ({ onSearch, searchTerm = "" }: EtatParentProps) => {
    ...
    const pagination = useSelector(
        (state: TRootState) => state.etatEncaissement?.data?.pagination || {
            currentPage: 1,
            previousPage: null,
            nextPage: null,
            count: 0,
    ...
    return (
        <div className="mb-5">
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm mb-5 p-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-gray-100">
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        >
                            <IconHome className="w-3.5 h-3.5 mr-1" />
                            Accueil
                        </Link>
                        <span className="text-gray-400">/</span>
                        <span className="text-primary font-medium inline-flex items-center">
                            <IconBox className="w-3.5 h-3.5 mr-1" />
